...
for s in range(0,9):
   ...
   while (value == False and i < 45) :
      ...
      value =  MonkeyImage.sameAs( sub_image, reference, 0.8 )
      print(i)
      # click on rescan if there is
      reference2 = MonkeyRunner.loadImageFromFile('C:\\Users\\G603606\\Rescan.png')
      sub_image2 = newimage.getSubImage((132./1080*WIDTH_PHONE,1227./2032*HEIGHT_PHONE,816./1080*WIDTH_PHONE,148./2032*HEIGHT_PHONE))
      if MonkeyImage.sameAs( sub_image2, reference2, 0.8 ):
         device.touch(540./1080*WIDTH_PHONE,1301./2032*HEIGHT_PHONE,'DOWN_AND_UP')
